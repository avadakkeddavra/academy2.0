            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form class="cafedraForm" role="form">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if($type == 'update')
                                            <input type="text" id="title" class="form-control" value="{{$cafedra->name}}" placeholder="Название">
                                        @elseif($type == 'create')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Заведующий</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                        @if($type == 'update')
                                            <select name="" id="teacher_id" class="form-control">
                                                @foreach($teachers as $teacher)
                                                    @if($teacher->id == $cafedra->header_id)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        @if($type == 'update')
                                            ...
                                            <input type="file" id="file" name="image" style="display: inline-block;" accept="image/jpeg,image/png,image/gif" value="{{$cafedra->img}}">
                                            ...
                                            <p class="file_checked_name">{{$cafedra->img}}</p>
                            ...
                            <div class="col-md-12">
                                <div class="input-group" style='display: block;'>
                                    @if($type == 'update')
                                        <textarea id="text" style="width: 100%;">{{$cafedra->description}}</textarea>
                                    @elseif($type == 'create')
...
@section('scriptcustom')
    ...
    <script>
        ...
        $('#create').on('click',function(){
            ...
            var data = {
                title: $('.cafedraForm #title').val(),
                img: img,
                teacher_id: $('.cafedraForm #teacher_id').val(),
            ...
            if(type == 'create')
            {
                ...
                var url = '/admin/update/cafedra/'+id;
            }
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    {
                        noty('success','Успешно','Кафедра успешно создана');
                    }
                    else{
